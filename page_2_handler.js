...
async function draw_personal_data(page, font, bold, data) {
    ...
    // Вводим "Является ИП".
    page.drawText(data.business_type, {
        x: 437,
        y: 599,
        font: bold,
        size: 11,
...
async function drawTables(page, pdfDoc, propertyTableArea, incomeTableArea, data, drawTableFunc, custom_font, custom_bold_font, amountFont) {
    ...
    await draw_dawn_content_page(page, pdfDoc, data, current_y, drawTableFunc, custom_font, custom_bold_font, amountFont, newTableCoordinatesProperty, newTableCoordinatesIncome, newStartY, newStartYProperty);
};
